...
Oremos: Infunde, Señor, tu gracia en nuestras almas, para que los que hemos conocido por el anuncio del Ángel la Encarnación de tu Hijo Jesucristo, lleguemos por su Pasión y su Cruz a la gloria de la Resurrección. Por Cristo nuestro Señor. Amén.`,
  ...
  examCategories: {
    firstCommandment: {
      name: 'Primer Mandamiento: Adorar a Dios y amarlo sobre todas las cosas',
      sins: [
        { id: 'p1-1', description: '¿Descuidé el conocimiento de mi fe?' },
        { id: 'p1-2', description: '¿Dudé de alguna enseñanza de la Iglesia?' },
        { id: 'p1-3', description: '¿Consulté horóscopos, fui a adivinos o practiqué superstición?' },
        { id: 'p1-4', description: '¿Participé en sesiones espiritistas o cultos de otras religiones?' },
        { id: 'p1-5', description: '¿Abandoné la fe católica?' },
        { id: 'p1-6', description: '¿Dejé de rezar por mucho tiempo?' },
        { id: 'p1-7', description: '¿Puse algo o alguien por encima de Dios en mi vida?' },
      ],
    },
    secondCommandment: {
      name: 'Segundo Mandamiento: No usar el Santo Nombre de Dios en vano',
      sins: [
        { id: 'p2-1', description: '¿Blasfemé el nombre de Dios, de la Virgen María o de los Santos?' },
        { id: 'p2-2', description: '¿Juré en falso o en vano?' },
        { id: 'p2-3', description: '¿Dije palabras irreverentes o profanas?' },
        { id: 'p2-4', description: '¿Irrespeté lugares, personas u objetos sagrados?' },
      ],
    },
    thirdCommandment: {
      name: 'Tercer Mandamiento: Santificar los Domingos y fiestas de guardar',
      sins: [
        { id: 'p3-1', description: '¿Dejé de participar en la Misa los Domingos y Fiestas de precepto?' },
        { id: 'p3-2', description: '¿Llegué tarde o salí antes de que terminara la Misa sin motivo grave?' },
        { id: 'p3-3', description: '¿Estuve conversando durante la Misa?' },
        { id: 'p3-4', description: '¿Usé el celular durante la Santa Misa sin necesidad?' },
        { id: 'p3-5', description: '¿Trabajé innecesariamente en Domingo?' },
      ],
    },
    fourthCommandment: {
      name: 'Cuarto Mandamiento: Honrar padre y madre',
      sins: [
        { id: 'p4-1', description: '¿Desobedecí o irrespeté a mis padres?' },
        { id: 'p4-2', description: '¿Dejé de ayudar a mis padres cuando lo necesitaron?' },
    ...
    fifthCommandment: {
      name: 'Quinto Mandamiento: No matar',
      sins: [
        { id: 'p5-1', description: '¿Maté, herí o agredí a alguien físicamente?' },
        { id: 'p5-2', description: '¿Provoqué o incentivé el aborto?' },
        { id: 'p5-3', description: '¿Pensé en el suicidio o intenté quitarme la vida?' },
        { id: 'p5-4', description: '¿Usé drogas o abusé del alcohol?' },
        { id: 'p5-5', description: '¿Puse en riesgo mi salud o la de otros?' },
        { id: 'p5-6', description: '¿Deseé mal a alguien?' },
        { id: 'p5-7', description: '¿Guardé rencor, odio o deseo de venganza?' },
        { id: 'p5-8', description: '¿Escandalicé a alguien, llevándolo al pecado?' },
      ],
    },
    sixthNinthCommandment: {
      name: 'Sexto y Noveno Mandamientos: Guardar castidad',
      sins: [
        { id: 'p6-1', description: '¿Cometí adulterio o fornicación?' },
        { id: 'p6-2', description: '¿Practiqué actos impuros solo (masturbación)?' },
        { id: 'p6-3', description: '¿Consentí en pensamientos o deseos impuros?' },
        { id: 'p6-4', description: '¿Vi pornografía o películas inmorales?' },
        { id: 'p6-5', description: '¿Tuve conversaciones o miradas impuras?' },
        { id: 'p6-6', description: '¿Practiqué algún tipo de relación sexual fuera del matrimonio?' },
        { id: 'p6-7', description: '¿Usé métodos anticonceptivos artificiales?' },
        { id: 'p6-8', description: '¿Cometí actos homosexuales?' },
      ],
    },
    seventhTenthCommandment: {
      name: 'Séptimo y Décimo Mandamientos: No robar, no codiciar',
      sins: [
        { id: 'p7-1', description: '¿Robé o hurté algo?' },
        { id: 'p7-2', description: '¿Perjudiqué a alguien en sus bienes?' },
        { id: 'p7-3', description: '¿Fui deshonesto en el trabajo o en los estudios?' },
        { id: 'p7-4', description: '¿Dejé de pagar deudas que podía pagar?' },
        { id: 'p7-5', description: '¿Envidié los bienes de otros?' },
        { id: 'p7-6', description: '¿Fui codicioso o apegado en exceso a los bienes materiales?' },
        { id: 'p7-7', description: '¿Dejé de ayudar a los pobres pudiendo hacerlo?' },
      ],
    },
    eighthCommandment: {
      name: 'Octavo Mandamiento: No levantar falso testimonio',
      sins: [
        { id: 'p8-1', description: '¿Mentí o engañé a alguien?' },
        { id: 'p8-2', description: '¿Chismeé o esparcí rumores sobre otras personas?' },
        { id: 'p8-3', description: '¿Difamé o calumnié a alguien?' },
        { id: 'p8-4', description: '¿Revelé secretos confiados a mí?' },
        { id: 'p8-5', description: '¿Juzgué a los demás sin motivo?' },
        { id: 'p8-6', description: '¿Fui hipócrita o fingí ser lo que no soy?' },
      ],
    },
    churchCommandments: {
      name: 'Mandamientos de la Iglesia y Santa Misa',
      sins: [
        { id: 'mi-1', description: '¿Dejé de participar en la Misa los Domingos y Fiestas de precepto?' },
        { id: 'mi-2', description: '¿Incumplí el ayuno o abstinencia prescritos?' },
        { id: 'mi-3', description: '¿Dejé de confesarme al menos una vez al año?' },
        { id: 'mi-4', description: '¿No recibí la Sagrada Eucaristía al menos en Pascua?' },
        { id: 'mi-5', description: '¿Comulgué en pecado mortal?' },
        { id: 'mi-6', description: '¿No contribuí a las necesidades de la Iglesia según mis posibilidades?' },
      ],
    },
    capitalSins: {
      name: 'Siete Pecados Capitales',
      sins: [
        { id: 'pc-1', description: 'SOBERBIA: ¿Fui orgulloso, vanidoso o arrogante?' },
        { id: 'pc-2', description: 'AVARICIA: ¿Fui apegado al dinero y a las cosas materiales?' },
        { id: 'pc-3', description: 'ENVIDIA: ¿Tuve envidia de los bienes o cualidades de otros?' },
        { id: 'pc-4', description: 'IRA: ¿Fui impaciente, rencoroso o violento?' },
        { id: 'pc-5', description: 'LUJURIA: ¿Consentí en pensamientos, deseos o actos impuros?' },
        { id: 'pc-6', description: 'GULA: ¿Excedí al comer, beber o usar drogas?' },
        { id: 'pc-7', description: 'PEREZA: ¿Tuve pereza de rezar, trabajar o ayudar a los demás?' },
      ],
    },
    blasphemiesMary: {
      ...
      sins: [
        ...
        { id: 'bm-5', description: '¿Menosprecié o ridiculicé a María o a los Santos en sus santas imágenes?' },
      ],
    },
    mercyWorks: {
      name: 'Obras de Misericordia Espirituales y Corporales',
      sins: [
        { id: 'om-1', description: '¿Dejé de dar buen consejo a los que pecan?' },
        { id: 'om-2', description: '¿Dejé de enseñar a algún ignorante?' },
        { id: 'om-3', description: '¿Dejé de consolar a los tristes?' },
        { id: 'om-4', description: '¿Dejé de perdonar a mis hermanos por amor a Dios?' },
        { id: 'om-5', description: '¿Dejé de rogar por los vivos y por los muertos?' },
        { id: 'om-6', description: '¿Dejé de dar de comer al hambriento?' },
        { id: 'om-7', description: '¿Dejé de dar de beber al sediento?' },
        { id: 'om-8', description: '¿Dejé de vestir al desnudo?' },
        { id: 'om-9', description: '¿Dejé de visitar a los presos?' },
        { id: 'om-10', description: '¿Dejé de ayudar o acoger a algún desamparado?' },
        { id: 'om-11', description: '¿Dejé de visitar a algún enfermo?' },
        { id: 'om-12', description: '¿Dejé de enterrar a los muertos o de visitar el cementerio?' },
      ],
    },
  },
